...
- 上传一个图片消耗 5 积分，上传一个视频消耗 10 积分；批量上传按成功保存的作品类型和数量累计扣除。
- 新建团队消耗 2000 积分，由创建团队的维护者个人账户扣除。
- 成功发布一次标准作品集消耗 10 积分，个人作品集扣所属维护者，团队作品集扣本次执行发布的维护者。
- 维护一次高级作品集消耗 20 积分，个人作品集扣所属维护者，团队作品集扣本次执行编辑、保存或发布的维护者。
...
- 高级作品集每次 AI 成功生成页面，或成功保存草稿/发布，分别计为一次高级维护动作并扣 20 积分；发起动作前必须展示预计消耗，失败不扣分。
- 团队无积分管理，团队作品集无积分消耗；访客从团队作品集跳转后，消耗个人作品集所属维护者的个人作品集积分。
- 上传作品在上传成功并保存作品记录后扣除积分；图片扣 5 积分，视频扣 10 积分；批量上传按成功保存的作品类型和数量累计扣除。
- 从 2026-07 账期开始，作品存储月费按总文件大小中的完整 2MB 单位计费，每个完整单位扣 1 积分，未满 2MB 的剩余部分不进位。
- 新建团队在团队创建成功并生成团队唯一码后扣除 2000 积分。
- 标准个人作品集在发布成功后，从作品集所属维护者账户扣除 10 积分；高级作品集按高级维护规则扣除。
- 标准团队作品集在发布成功后，从本次执行发布的维护者账户扣除 10 积分；高级团队作品集按高级维护规则扣除。
...
| 5 | 标准个人作品集 | 分享信息配置、固定组件(轮播图→档期查询→作品列表→联系信息→微信二维码)、维护页/预览页/访客页三态、草稿/发布版本管理、保存草稿不扣分/成功发布扣5积分、发布后分享 |
