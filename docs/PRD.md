...
本文档以 `design/prototype.html` 的 28 个页面设计稿为主要交互依据，并保留设计稿尚未覆盖但属于 MVP 闭环的业务能力。页面文案用于说明业务意图，最终上线文案可在不改变业务规则的前提下优化。
...
| 08 | 团队成员列表 | 三种团队角色 | 三种角色均可查看和搜索已加入成员；拥有者额外显示待确认等状态筛选和成员维护操作，其他角色为只读模式 |
| 09 | 团队成员维护 | 团队拥有者 | 唯一码匹配、管理者/普通成员角色、角色权限气泡、职业、内容引用权限和邀请确认 |
| 10 | 作品 | 维护者 | 搜索、标签筛选、引用次数和批量管理 |
| 11 | 批量添加作品 | 维护者 | 最多 9 个素材、文件列表和统一标签 |
| 12 | 作品编辑 | 维护者 | 标题、标签、说明及引用明细 |
| 13 | 作品集 | 维护者 | 个人/团队筛选、角色标识及按拥有者/管理者/普通成员展示管理、预览、分享操作 |
| 14 | 标准个人作品集维护 | 维护者 | 分享信息、固定组件（含联系信息）、草稿、预览和发布 |
| 15 | 标准个人作品集预览 | 维护者 | 模拟访客效果，联系信息禁用预览，保留返回且不统计、不提交、不扣分 |
| 16 | 组件库简介 | 维护者 | 用业务语言说明高级作品集可用模块，包含预留联系信息组件 |
| 17 | 高级个人作品集维护 | 维护者 | 素材编号、自然语言、AI 生成、预留联系信息、组件调整和发布 |
| 18 | 高级个人作品集预览 | 维护者 | 高级视觉及联系表单禁用预览，保留返回且不统计、不提交、不扣分 |
| 19 | 访客个人作品集 | 访客 | 标准个人作品集浏览、档期查询、主动预留联系信息和扫码联系 |
| 20 | 访客高级作品集 | 访客 | 高级个人作品集浏览、档期查询、主动预留联系信息和扫码联系 |
| 21 | 团队展示与成员 | 访客 | 团队介绍、聚合档期、成员作品集、主动预留联系信息和团队联系 |
| 22 | 访客档期查询 | 访客 | 日期、查询范围、档位状态和结果提示 |
| 23 | Under Maintenance | 访客 | 余额不足时保留页面骨架并遮罩内容区 |
| 24 | 档期 | 维护者 | 月历概览、日期明细和当天维护入口 |
| 25 | 档位定义 | 维护者 | 全部定义、启用/停用和新增入口 |
| 26 | 编辑档位定义弹层 | 维护者 | 名称、状态、起止时间、颜色和快照提示 |
| 27 | 新增档位定义弹层 | 维护者 | 新建档位定义但不自动创建具体日期档期 |
| 28 | 档期维护 | 维护者 | 选择档位、状态、联系人、电话、备注、删除和保存 |
...
| 2 | 我的（工作台） | 身份摘要、积分余额 + 低余额提醒、业务指标、访问记录入口、我的团队入口、基础信息编辑、退出登录、唯一码复制+二维码 |
