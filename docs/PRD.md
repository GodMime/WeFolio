...
- 成功发布一次标准作品集消耗 5 积分，个人作品集扣所属维护者，团队作品集扣本次执行发布的维护者。
- 维护一次高级作品集消耗 10 积分，个人作品集扣所属维护者，团队作品集扣本次执行编辑、保存或发布的维护者。
- 访客访问一次个人标准作品集消耗 1 积分，同一访客访问同一作品集距上次成功扣费不足 2 小时时不重复扣分。
- 访客访问一次个人高级作品集消耗 1 积分，同一访客访问同一作品集距上次成功扣费不足 2 小时时不重复扣分。
- 团队无积分账户，团队作品集访问无消耗；访客从团队作品集跳转到个人作品集后，再按个人作品集规则扣除所属维护者积分。
- 访客在个人作品集每次查看图片大图消耗 1 积分，同一访客查看同一作品距上次成功扣费不足 2 小时时不重复扣分。
- 访客在个人作品集每次查看视频消耗 5 积分，同一访客查看同一作品距上次成功扣费不足 2 小时时不重复扣分。
...
- 标准作品集仅在成功发布后扣 5 积分；保存草稿、打开编辑页、修改未保存、预览或失败请求不扣分。
...
- 标准个人作品集在发布成功后，从作品集所属维护者账户扣除 5 积分；高级作品集按高级维护规则扣除。
- 标准团队作品集在发布成功后，从本次执行发布的维护者账户扣除 5 积分；高级团队作品集按高级维护规则扣除。
- 访客访问个人作品集在页面成功打开时扣除 1 积分；后端按被扣费维护者 + 积分场景 + 全局访客 ID + 作品集 ID 维护滚动窗口，距上次成功扣费不足 120 分钟时不重复扣分。
...
- 视频每次播放或打开详情扣除 5 积分，后端按被扣费维护者 + 视频查看场景 + 全局访客 ID + 作品 ID 维护滚动窗口，距上次成功扣费不足 120 分钟时不重复扣分。
